/** @file
  Platform Device Security Policy PPI definition
...
#ifndef __EDKII_DEVICE_SECURITY_POLICY_PPI_H__
#define __EDKII_DEVICE_SECURITY_POLICY_PPI_H__
...
//
// Revision The revision to which the DEVICE_SECURITY_POLICY PPI interface adheres.
//          All future revisions must be backwards compatible.
//          If a future version is not back wards compatible it is not the same GUID.
//
#define EDKII_DEVICE_SECURITY_POLICY_PPI_REVISION 0x00010000
...
#define EDKII_DEVICE_SECURITY_STATE_ERROR_UEFI_GET_POLICY_PPI        (EDKII_DEVICE_SECURITY_STATE_ERROR + 0x1)
