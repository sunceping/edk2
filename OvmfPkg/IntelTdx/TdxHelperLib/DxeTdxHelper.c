  ...
  )
{
  ...
  // UINT8               *OldVariableData;
  // UINTN               OldVariableDataSize;
  ...
  //   OldVariableData = AllocatePool(OldVariableDataSize);
  //   if (OldVariableData == NULL) {
  //     ASSERT(FALSE);
  ...
  //     VariableDataSize = OldVariableDataSize + sizeof(CcEventVariableHeader) + CcEventVariableHeader.LogSize;
  //     DEBUG ((DEBUG_ERROR, "%a: OldVariableDataSize %d VariableDataSize %d\n", __func__, OldVariableDataSize, VariableDataSize));
  //     VariableData     = AllocatePool(VariableDataSize);
  //     DEBUG ((DEBUG_ERROR, "%a: [SUNCE] %d\n", __func__, __LINE__));
  ...
  Ptr = VariableData;
  // if ((Status == EFI_SUCCESS) && (OldVariableData != NULL) && (VariableDataSize > OldVariableDataSize)) {
  //   DEBUG ((DEBUG_ERROR, "%a: [SUNCE] %d\n", __func__, __LINE__));
  //   CopyMem(Ptr, OldVariableData, OldVariableDataSize);
  //   DEBUG ((DEBUG_ERROR, "%a: [SUNCE] %d\n", __func__, __LINE__));
  //   Ptr += OldVariableDataSize;
  // }
  // DEBUG ((DEBUG_ERROR, "%a: [SUNCE] %d\n", __func__, __LINE__));
  ...
  DEBUG ((DEBUG_ERROR, "%a: [SetVariable] %r\n", __func__, Status));
  ...
  )
{
  ...
  DEBUG ((DEBUG_ERROR, "%a: [SUNCE] entring\n", __func__));
